...
if ( defined( 'myCRED_VERSION' ) ) {
	 ...
	 * @version 1.0
	 */
	add_filter( 'mycred_setup_hooks', 'wp_postratings_myCRED_Hook' );
	function wp_postratings_myCRED_Hook( $installed ) {
	 ...
	 * @version 1.0
	 */
	if ( ! class_exists( 'myCRED_WP_Postratings' ) && class_exists( 'myCRED_Hook' ) ) {
