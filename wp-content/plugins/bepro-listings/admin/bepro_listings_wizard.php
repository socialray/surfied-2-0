			...
			<div id="tb1_4" class="tab-pane hidden">
				...
				<div class="wizard_info">
					...
					<ul id="info_options">
						...
						<li><?php _e("Search through our","bepro-listings"); ?> <a href="http://beprothemes.com" target="_blank"><?php _e("Demos","bepro-listings"); ?></a> <?php _e("on beprothemes.com","bepro-listings"); ?></li>
